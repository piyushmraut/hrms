...
const Projects = () => {
  ...
  return (
    ...
    //       <h1 className="text-3xl font-bold text-violet-900">Project Management Dashboard</h1>
  ...
  <div className="space-y-6">
    <div className="bg-white shadow-lg rounded-xl p-6 border border-gray-100">
      ...
      <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-violet-300 scrollbar-track-transparent rounded-lg">
        ...
        {/* Team View with improved styling */}
{activeTab === 'team' && (
  <div className="space-y-6">
    <div className="bg-white shadow-lg rounded-xl p-6 border border-gray-100">
      <div className="flex justify-between items-center mb-6">
...
{/* Tasks View with improved styling */}
{/* {activeTab === 'tasks' && (
  <div className="space-y-6">
    <div className="bg-white shadow-lg rounded-xl p-6 border border-gray-100">
      <div className="flex justify-between items-center mb-6">
              ...
              return (
                <tr key={task.id} className="hover:bg-gray-50 transition-colors duration-200">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    {assignee ? (
                      <div className="flex items-center">
                        <div className="flex-shrink-0 h-8 w-8 rounded-full bg-gradient-to-br from-violet-500 to-indigo-600 flex items-center justify-center text-white font-bold text-xs shadow-sm mr-2">
                          {assignee.name.charAt(0)}
                        </div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium flex space-x-2">
                    <select
                      className="border border-gray-300 rounded-md shadow-sm focus:ring-violet-500 focus:border-violet-500 text-sm"
                      value={task.status}
                      onChange={(e) => updateTaskStatus(task.id, e.target.value)}
                    >
                      <option value="Not Started">Not Started</option>
