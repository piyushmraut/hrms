...
const Offers = () => {
  ...
  <div className="pt-6 flex justify-end space-x-4">
    ...
    >
      ...
      {/* {isViewModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl shadow-xl max-w-xl w-full max-h-screen overflow-y-auto animate-fade-in">
            <div className="p-8">
              <div className="flex justify-between items-center mb-6">
              ...
              {selectedOffer && (
                <div className="space-y-4 text-gray-700">
                  <div className="pb-4 border-b border-gray-100">
                    ...
                    <p className="text-lg font-semibold mt-1">{selectedOffer.candidateName}</p>
                  </div>
                  <div className="pb-4 border-b border-gray-100">
                    <span className="text-sm text-gray-500">Position</span>
                    <p className="text-lg font-semibold mt-1">{selectedOffer.position}</p>
                  </div>
                  <div className="pb-4 border-b border-gray-100">
                    <span className="text-sm text-gray-500">Salary</span>
                    <p className="text-lg font-semibold mt-1">{selectedOffer.salary}</p>
                  </div>
                  <div className="pb-4 border-b border-gray-100">
                    <span className="text-sm text-gray-500">Bonus</span>
                    <p className="text-lg font-semibold mt-1">{selectedOffer.bonus || 'None'}</p>
                  </div>
                  <div className="pb-4 border-b border-gray-100">
                    <span className="text-sm text-gray-500">Benefits</span>
                    <p className="text-base mt-1">{selectedOffer.benefits || 'None specified'}</p>
                  </div>
                  <div className="pb-4 border-b border-gray-100">
                    <span className="text-sm text-gray-500">Start Date</span>
                    <p className="text-lg font-semibold mt-1">{selectedOffer.startDate}</p>
                  </div>
                  <div className="pb-4 border-b border-gray-100">
                    ...
                    <p className="mt-1">
                      <span className={`px-3 py-1 inline-flex text-sm leading-5 font-semibold rounded-full ${
                        ...
                        {selectedOffer.status === 'Accepted' && <CheckCircle size={14} className="mr-1" />}
                        {selectedOffer.status === 'Rejected' && <XCircle size={14} className="mr-1" />}
                        {selectedOffer.status === 'Pending' && <Clock size={14} className="mr-1" />}
                  ...
                  <div>
                    ...
                    <p className="text-base mt-1">{selectedOffer.sentDate}</p>
                  </div>
                </div>
              )}
              <div className="mt-8 flex justify-end">
                <button
                  ...
                  className="px-6 py-3 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition-colors flex items-center gap-2"
                >
                  <Edit size={16} />
                  Edit Offer
                </button>
