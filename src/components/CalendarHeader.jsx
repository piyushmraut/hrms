...
//         <h1 className="text-2xl font-bold text-gray-800">HRMS Calendar</h1>
//         <button
//           onClick={onAddEvent}
...
//         <div>
//           <h1 className="text-2xl font-bold text-gray-800">HRMS Calendar</h1>
//           <h2 className="text-xl font-medium text-indigo-600 mt-1">
//             {format(currentDate, 'MMMM yyyy')}
//           </h2>
//         </div>
//         <button
//           onClick={onAddEvent}
//           className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md shadow-sm flex items-center transition-colors duration-200"
//         >
//           <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
//             <path fillRule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clipRule="evenodd" />
//           </svg>
...
//       <div className="flex flex-wrap justify-between items-center bg-white rounded-lg shadow-sm p-3">
//         <div className="flex space-x-2">
//           <button
//             onClick={() => onViewChange('dayGridMonth')}
