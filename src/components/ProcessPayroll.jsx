...
// const ProcessPayroll = () => {
//   const [payrollPeriod, setPayrollPeriod] = useState({ startDate: '', endDate: '', payDate: '' });
//   const [employees, setEmployees] = useState([]);
//   const [selectedEmployees, setSelectedEmployees] = useState([]);
//   const [isProcessing, setIsProcessing] = useState(false);
//   const [isProcessed, setIsProcessed] = useState(false);
...
//           period: `${payrollPeriod.startDate} to ${payrollPeriod.endDate}`,
...
//       const existingPayslips = JSON.parse(localStorage.getItem('payroll_payslips') || '[]');
//       localStorage.setItem('payroll_payslips', JSON.stringify([...existingPayslips, ...payslips]));

//       const totalAmount = payslips.reduce((sum, payslip) => sum + payslip.netSalary, 0);
//       setProcessedData({
//         period: payrollPeriod,
//         employees: selectedEmpData,
//         totalAmount,
...
//             <div>
//               <label className="block text-sm font-medium text-gray-700 mb-1">Start Date</label>
//               <input type="date" name="startDate" value={payrollPeriod.startDate} onChange={handleInputChange} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required />
//             </div>
//             <div>
//               <label className="block text-sm font-medium text-gray-700 mb-1">End Date</label>
//               <input type="date" name="endDate" value={payrollPeriod.endDate} onChange={handleInputChange} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required />
//             </div>
//             <div>
//               <label className="block text-sm font-medium text-gray-700 mb-1">Pay Date</label>
//               <input type="date" name="payDate" value={payrollPeriod.payDate} onChange={handleInputChange} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required />
//             </div>
//           </div>
...
//                 <tr>
//                   <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
//                     <input type="checkbox" checked={selectedEmployees.length === employees.length && employees.length > 0} onChange={selectAllEmployees} className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" />
//                   </th>
//                   <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Employee ID</th>
//                   <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Name</th>
//                   <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Department</th>
...
//                   <tr key={employee.id} className="hover:bg-gray-50">
//                     <td className="px-6 py-4 whitespace-nowrap">
//                       <input type="checkbox" checked={selectedEmployees.includes(employee.id)} onChange={() => toggleEmployeeSelection(employee.id)} className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" />
//                     </td>
//                     <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{employee.employeeId}</td>
//                     <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{employee.name}</td>
//                     <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{employee.department}</td>
...
//           <div className="mt-6 flex justify-end">
//             <button onClick={processPayroll} disabled={!payrollPeriod.startDate || !payrollPeriod.endDate || !payrollPeriod.payDate || selectedEmployees.length === 0 || isProcessing} className={`px-6 py-2 rounded-md text-white ${isProcessing || !payrollPeriod.startDate || !payrollPeriod.endDate || !payrollPeriod.payDate || selectedEmployees.length === 0 ? 'bg-blue-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'}`}>
//               {isProcessing ? 'Processing...' : 'Process Payroll'}
//             </button>
//           </div>
//         </div>
...
//             <h2 className="text-xl font-semibold text-gray-800">Payroll Processed Successfully</h2>
//             <div className="flex gap-2">
//               <button onClick={handlePrint} className="flex items-center gap-2 bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-50"><FiPrinter /> Print</button>
//               <button onClick={handleDownload} className="flex items-center gap-2 bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-50"><FiDownload /> Download</button>
//             </div>
//           </div>
...
//               <div>
//                 <h3 className="text-lg font-medium text-green-800">Payroll Processed</h3>
//                 <p className="text-sm text-green-700 mt-1">The payroll for {processedData.employees.length} employees has been processed successfully. Total amount: ${processedData.totalAmount.toLocaleString()}</p>
//               </div>
//             </div>
//           </div>
...
//             <div className="bg-gray-50 p-4 rounded-lg">
//               <h3 className="text-sm font-medium text-gray-500">Payroll Period</h3>
//               <p className="text-lg font-semibold text-gray-800 mt-1">{processedData.period.startDate} to {processedData.period.endDate}</p>
//             </div>
//             <div className="bg-gray-50 p-4 rounded-lg">
//               <h3 className="text-sm font-medium text-gray-500">Payment Date</h3>
//               <p className="text-lg font-semibold text-gray-800 mt-1">{processedData.period.payDate}</p>
//             </div>
//             <div className="bg-gray-50 p-4 rounded-lg">
//               <h3 className="text-sm font-medium text-gray-500">Total Amount</h3>
//               <p className="text-lg font-semibold text-green-600 mt-1">${processedData.totalAmount.toLocaleString()}</p>
//             </div>
//           </div>
...
//           <div className="mt-6 flex justify-end">
//             <button onClick={() => setIsProcessed(false)} className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Process New Payroll</button>
//           </div>
//         </div>
//       )}
//     </div>
